...
public class Ejercicio12 {
  public static void main(String[] args) {
    System.out.println("Este genera un nuevo array a partir de una posición final y una inicial.");
      ...
      if ((posInicial > posFinal) || (posInicial < 0) || (posInicial > 9) || (posFinal < 0) || (posFinal > 9)) {
        ...
        System.out.print("La posición inicial debe ser menor a la final y ambos deben estar entre 0 y 9.");
          ...
          for (int x = (posFinal + 1); x < 10; x++) {
            nuevo[x] = num[i];
            i++;
          } //ordena los últimos a partir de la posicion final + 1
          ...
          } //ordena los primeros números
          
          System.out.println("El nuevo array es:");
          for (int x = 0; x < 10; x++) {
            System.out.println("Posicion " + x + " es: " + nuevo[x]);
          }   //muestra los números del nuevo array
      }
  }
}

...
public class Ex12emfn2 {
    public static void main(String[] args) {
        ...
        almacenUno.add(new Articulo("111", "Leche", "brick", 5.55, 55.55, 5));
        almacenUno.add(new Articulo("222", "Atún", "enlatado", 6.66, 66.66, 6));
        almacenUno.add(new Articulo("333", "Agua", "embotellado", 2.22, 22.55, 8));
        almacenUno.add(new Articulo("444", "Lentejas", "a granel", 6.66, 66.66, 6));
        almacenUno.add(new Articulo("555", "Comida de gato", "enlatado", 2.22, 22.55, 8));
        ...
        while(menu != 7) {
            ...
            switch(menu) {
                case 1:
                    //Pregunta si se quiere listar por tipo de envasado
                     ...
                     if(r.equals("n")) {
                        ...
                        System.out.println("Listado completo de artículos--------------");
                        for(Articulo x: almacenUno) {
                        ...
                        System.out.print("¿Qué tipo de envasado desea listar?: ");
                ...
                case 2:
                    ...
                    //Crea el artículo
                    almacenUno.add(new Articulo(cod, desc, env, precComp, precVent, stock));
                ...
                case 4:
                    ...
                    switch(menuUp) {
                        ...
                        case 6:
                            ...
                            almacenUno.get(x).setEnvasado(envUp);
                            System.out.println("El artículo fue modificado con éxito.");
                        break;
                        default:
